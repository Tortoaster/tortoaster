...
<main class="flex flex-col gap-half p-half">
    ...
    <div class="flex gap-single justify-center">
        ...
        <a class="p-half rounded-normal hover:bg-black-darker text-black-darker hover:text-black transition-colors duration-200 ease-out" aria-label="E-mail" href="mailto:rick@tortoaster.com"><span class="icon-[fa6-solid--envelope] size-double block"></span></a>
    </div>
</main>
